# Guia Angular (v18+) [WIP]

> Guia focado em **Angular moderno** (Standalone APIs, Signals, SSR, RxJS moderno, arquitetura escalável e ecossistema atual).

# Contents

- [Recursos Oficiais](#official-resources)
- [JavaScript & TypeScript](#javascript--typescript)
- [Cursos Iniciantes](#cursos-iniciantes)
- [Cursos Avançados](#cursos-avançados)
- [Tópicos Especializados](#tópicos-especializados)
- [Canais do YouTube](#canais-do-youtube)
- [Blogs & Notícias](#blogs)
- [Comunidades](#comunidades)

# Recursos Oficiais

- [(🐐) Angular Docs](https://angular.dev)
> Considerada por muitos uma das melhores documentações do ecossistema frontend.

- [(⭐) Learn Angular](https://angular.dev/tutorials/learn-angular)
> Tutorial oficial passo a passo.

- [(⭐) Angular Roadmap](https://angular.dev/roadmap)
> Melhor forma de acompanhar o futuro do framework.

- [(⭐) Angular Blog](https://blog.angular.dev/)
> Novidades oficiais, releases, RFCs e mudanças importantes.

- [(🇺🇸) Angular YouTube](https://www.youtube.com/@Angular)

# JavaScript & TypeScript

- [(🇧🇷) TypeScript para Iniciantes — Felipe Rocha](https://www.youtube.com/watch?v=ppDsxbUNtNQ)
> ⚠️ Ainda não avaliado.

- [(🇧🇷, 💲, 🐐) JavaScript e TypeScript do básico ao avançado — Luiz Otávio Miranda](https://www.udemy.com/course/curso-de-javascript-moderno-do-basico-ao-avancado/)
> ⚠️ Ainda não avaliado.

> Um dos cursos mais recomendados pela comunidade BR.

- [(🇺🇸, 🐐) TypeScript Handbook](https://www.typescriptlang.org/docs/)
> Documentação oficial.

> Frequentemente recomendada antes de começar em Angular.

# Cursos Iniciantes

- [(🇧🇷, 🐐) Angular do Zero ao Avançado — Fernanda Kipper](https://www.youtube.com/playlist?list=PLNCSWIsR6ADJuQd4x6LVIC4VFMYArdg3M)
> ⚠️ Ainda não avaliado.

> Muito elogiado pela comunidade BR.

- [(🇧🇷) Angular 19 na prática — O Dev Lucas](https://www.youtube.com/playlist?list=PLAHPGKIfQVuIff8XNEhEN9-EJbwiQykCC)
> ⚠️ Ainda não avaliado.

- [(🇧🇷, 💲, ⭐) Introdução ao Angular — Code Dimension](https://www.codedimension.com.br/cursos/introducao-ao-angular)
> ⚠️ Ainda não avaliado.

- [(🇺🇸, ⭐) Modern Angular Course — Loiane Groner](https://www.youtube.com/playlist?list=PLGxZ4Rq3BOBqJfR254ZMuBfFRMeyr162U)
> ⚠️ Ainda não avaliado.

> Loiane é uma das maiores referências BR de Angular.
...
- [(🇺🇸, ⭐) Angular Signals + RxJS — Deborah Kurata](https://www.youtube.com/playlist?list=PLErOmyzRKOCrZ7aDGw4WYCtlQUVyKLRyq)
> ⚠️ Ainda não avaliado.
...
- [(🇺🇸, ⭐) Angular Signals Fast Track — Manfred Steyer](https://angular-signals.com/)
> ⚠️ Ainda não avaliado.
...
> Referência histórica de Angular no Brasil.

- [(🇧🇷) O Dev Lucas](https://www.youtube.com/@odevlucas)
...
> Conteúdo extremamente didático.

- [(🇺🇸, ⭐) Ninja Squad Blog](https://blog.ninja-squad.com/)
> Muito respeitado pela comunidade Angular.

# Comunidades

- [Angular Reddit](https://reddit.com/r/angular)
- [Angular 2 Reddit](https://reddit.com/r/Angular2)
